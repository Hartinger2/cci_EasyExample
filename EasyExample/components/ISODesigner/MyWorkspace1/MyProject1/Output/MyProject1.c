...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_2), TYPEID_MACRO, WORD(24),
		...
		CMD_CHANGE_BACKGROUND_COLOR, ID(Button_6005), COLOR_BLACK, 0xFF, 0xFF, 0xFF, 0xFF,
	...
	ID(Button_6005), TYPEID_BUTTON, WORD(96), WORD(94), 56, 249, 1, 0, 1, 1, 
