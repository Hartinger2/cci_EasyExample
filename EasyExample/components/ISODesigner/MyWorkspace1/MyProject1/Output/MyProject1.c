...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_S2), TYPEID_MACRO, WORD(16),
		...
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(440), WORD(100), WORD(0300)
	ID(Macro_2), TYPEID_MACRO, WORD(24),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask_Home), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 5, WORD(800), WORD(0200), WORD(0500)
		CMD_CHANGE_BACKGROUND_COLOR, ID(Button_zurueck), COLOR_BLACK, 0xFF, 0xFF, 0xFF, 0xFF,
	ID(Macro_3), TYPEID_MACRO, WORD(0),
	ID(Macro_4), TYPEID_MACRO, WORD(0),
	ID(Macro_drauf), TYPEID_MACRO, WORD(8),
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 9, 0, 
		...
		XYREF(Button_S2, 399, 135),
		XYREF(Button_einbl, 380, 21),
	ID(Seite_2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 2, 0, 
		XYREF(Button_zurueck, 378, 84),
		XYREF(Button_einbl, 132, 73),
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(80), WORD(79), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S2, -4, 26),
		MACRO(EV_KEYRELEASE, Macro_S2),
	ID(Button_zurueck), TYPEID_BUTTON, WORD(96), WORD(94), 56, 249, 1, 0, 1, 1, 
		XYREF(OutputString_zurueck, -4, 33),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_einbl), TYPEID_BUTTON, WORD(103), WORD(117), 249, 249, 1, 0, 1, 2, 
		XYREF(OutputString_einbl, -4, 78),
		MACRO(EV_KEYPRESS, Macro_drauf),
	...
	ID(OutputString_S2), TYPEID_OUTSTR, WORD(80), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(4), 'S', '2', ' ', ' ', 0,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_zurueck), TYPEID_OUTSTR, WORD(96), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(6), 'z', 'u', 'r', 'ü', 'c', 'k', 0,
	ID(OutputString_einbl), TYPEID_OUTSTR, WORD(177), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(FontAttributes_23000), TYPEID_FONTATTR, COLOR(197), 3, 0, 0, 0, 
